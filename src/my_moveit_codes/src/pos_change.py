...
#         pose = Pose(position=Point(*position), orientation=euler_to_quaternion(*orientation))
#         try:
#             kinematics_pose = SetKinematicsPoseRequest()
#             kinematics_pose.kinematics_pose.pose = pose
#             kinematics_pose.planning_group = "arm"
...
#         ((0.18, 0.0, 0.2), (0.0, 80, 0.0), "close", 0.1),  # Angles in degrees
#         # ((0.20, 0.0, 0.1), (0.0, 10, 0.0), "close", 0.2),
#         # ((0.2, 0.0, 0.08), (0.0, 5, 0.0), "close", 0.2),
#     ]
